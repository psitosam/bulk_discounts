...
RSpec.describe 'bulk discount index page' do
  ...
  it 'renders the bulk discount edit form with prepopulated data' do
    # save_and_open_page
    expect(page).to have_content("Discount Edit")
  ...
  it 'a completed form submits the edit form and updates the bulk discount' do
    ...
    expect(page).to have_content("Percent: 8")
